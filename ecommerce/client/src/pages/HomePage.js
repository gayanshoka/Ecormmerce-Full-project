            ...
            {products?.map((p) => (
              <div className="card m-2" key={p._id}>
                ...
                <div className="card-body">
                  ...
                  <button type="button" className="btn btn-primary mt-1" onClick={()=>navigate(`/product/${p.slug}`)}>More Deatailes</button>
                  <button type="button" className="btn btn-primary mt-1" onClick={()=>{setCart([...cart,p]);
